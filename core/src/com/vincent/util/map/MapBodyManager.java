...
public class MapBodyManager {
    ...
    private Shape getPolyline(PolylineMapObject polylineObject) {
        ...
        for (Vector2 worldVertice : worldVertices) {
            vector3.set(worldVertice.x, worldVertice.y, 0);
            vector3 = MapUtils.isoToGame(vector3);
            worldVertice.x = vector3.x;
            worldVertice.y = vector3.y;
        }
