...
public class AssetLoader {
    ...
    public static Animation playerDownLeft;
    ...
    public static void load() {
        ...
        manager.load("entities/player/down_left/down_left_anim.atlas", TextureAtlas.class);
        manager.load("entities/player/down/down_anim.atlas", TextureAtlas.class);
    ...
    public static void initAssets() {
        ...
        TextureAtlas playerDownLeftAnim = manager.get("entities/player/down_left/down_left_anim.atlas", TextureAtlas.class);
        TextureAtlas playerDownAnim = manager.get("entities/player/down/down_anim.atlas", TextureAtlas.class);
