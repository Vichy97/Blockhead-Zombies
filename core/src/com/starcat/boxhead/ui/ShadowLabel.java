...
public class ShadowLabel extends Widget {
    ...
    public ShadowLabel (CharSequence text, Skin skin) {
        this(text, skin.get(com.badlogic.gdx.scenes.scene2d.ui.Label.LabelStyle.class));
    }

    public ShadowLabel (CharSequence text, Skin skin, String styleName) {
        this(text, skin.get(styleName, com.badlogic.gdx.scenes.scene2d.ui.Label.LabelStyle.class));
    }

    /** Creates a label, using a {@link com.badlogic.gdx.scenes.scene2d.ui.Label.LabelStyle} that has a BitmapFont with the specified name from the skin and the specified
     * color. */
    ...
    /** Creates a label, using a {@link com.badlogic.gdx.scenes.scene2d.ui.Label.LabelStyle} that has a BitmapFont with the specified name and the specified color from the
     * skin. */
    ...
    public ShadowLabel (CharSequence text, com.badlogic.gdx.scenes.scene2d.ui.Label.LabelStyle style) {
        if (text != null) this.text.append(text);
        setStyle(style);
        if (text != null && text.length() > 0) setSize(getPrefWidth(), getPrefHeight());
    }

    public void setStyle (com.badlogic.gdx.scenes.scene2d.ui.Label.LabelStyle style) {
    ...
    /** Returns the label's style. Modifying the returned style may not have an effect until {@link #setStyle(com.badlogic.gdx.scenes.scene2d.ui.Label.LabelStyle)} is
     * called. */
    ...
    public void draw (Batch batch, float parentAlpha) {
        ...
        cache.tint(Color.BLACK);
        cache.setPosition(getX() - 5, getY() - 5);
        cache.draw(batch);
    ...
    /** The style for a label, see {@link com.badlogic.gdx.scenes.scene2d.ui.Label}.
     * @author Nathan Sweet */
